...
- **Фазы по очереди:** каждая видит заголовки предыдущих и конец текста предыдущей фазы;
  сводящий вызов пишет заголовок и блок сути по тексту фаз, не перечитывая транскрипт.
...
Версия 3.1.0 (2026-09-06); изменения после неё — в разделе `[Unreleased]` CHANGELOG.
