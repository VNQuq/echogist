...
Транскрипция идёт локально на видеокарте, резюме собирает Anthropic — по облачному
вызову на каждую фазу записи и один сводящий. Без логинов, истории и онлайн-источников.
...
2. Выбери действие. Для **видео** MP3-дорожка сохраняется в любом случае:
   ...
   Если на входе уже MP3, вариантов три: **Summary**, **Transcript only** или **Re-encode to a
   smaller MP3** (осознанно пережать тяжёлый файл).
...
Связная проза по ходу записи, блок сути (главная мысль, главный навык и три проверочных
вопроса — ответы на них собраны в самом конце документа), сквозные темы и — если они были —
решения и пункты к выполнению.
