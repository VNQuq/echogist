...
> **Ctrl-C здесь останавливает пачку, а не приложение.** Текущие конвертации гасятся, очередь
> отменяется, уже готовые MP3 остаются на диске, отчёт печатается, и ты возвращаешься в меню.
> Это единственное место, где Ctrl-C не выходит из EchoGist.
